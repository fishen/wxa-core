...
declare module "wxa-core/src/constants" {
    export const COMPUTED_DATA: unique symbol;
    export const BINDS: unique symbol;
    export const METHODS: unique symbol;
    export const OBSERVERS: unique symbol;
    export const LIFETIMES: unique symbol;
    export const PAGE_LIFETIMES: unique symbol;
    export const HOOK_FUNC: unique symbol;
}
...
declare module "wxa-core" {
    ...
    export { IWXApiProvider } from 'wxa-core/src/wx.type';
    export * as wxtype from 'wxa-core/src/wx.type';
}